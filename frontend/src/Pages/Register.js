...
export default function Register({registerOpen, handleCloseRegister, changeToLogin}) {
    ...
    return (
        <Dialog open={registerOpen} onClose={allowHandleClose} TransitionComponent={Transition} maxWidth='sm' fullWidth>
            <DialogContent >
                ...
                <Grid container direction='row' alignItems="center" justifyContent="center" spacing={0.65} sx={{marginTop: 2}}>
                    ...
                    <Grid item alignItems="center" justifyContent="center">
                        <Link component="button" variant="body1" onClick={handleChangeToLogin} underline="always">
                            Log in
                        </Link>
                    </Grid>
                </Grid>
            ...
            <DialogActions>
                ...
                <Button form="registerForm" type="submit" disabled={loading}>Register</Button>
            </DialogActions>
        </Dialog>
    )
}